...
这是一个包含 6 只 enhypen 桌宠的小应用。

## 下载说明

### Windows

- `ENHYPEN-Pets-win11-1.1.2.exe`
  - 免安装版本，下载后直接点击即可运行

- `ENHYPEN-Pets-win11-Setup-1.1.2.exe`
  - 安装版，下载后按照指引选择目录进行安装（推荐）

### macOS
- `ENHYPEN.Pets-1.1.2-arm64.dmg`
  - M系列芯片下载这个

- `ENHYPEN.Pets-1.1.2-x64.dmg`
  - Intel芯片下载这个
...
- 安装器会创建桌面快捷方式和开始菜单快捷方式，名称均为 `ENHYPEN Pets`。
...
![win托盘图片](pic/ehp.png)
 ...
 - macos托盘在屏幕左上角ENHYPEN Pets那里点开下拉框
