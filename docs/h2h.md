...
这是一个包含 9 只 H2H 桌宠的小应用。

## 下载说明

### Windows

- `H2H-Pets-Setup-1.0.0.exe`
  - 当前推荐版本。

- `H2H-Pets-win11-Setup-1.1.1.exe`
  - 如果1.0.0不行的话可以下载这个版本。

### macOS
- `H2H.Pets-1.1.0-arm64.dmg`
  - M系列芯片下载这个

- `H2H.Pets-1.1.0-x64.dmg`
  - Intel芯片下载这个
...
- 安装器会创建桌面快捷方式和开始菜单快捷方式，名称均为 `H2H Pets`。
