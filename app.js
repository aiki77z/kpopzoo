...
const apps = [
  ...
  },
  {
    ...
    files: {
      windows: "Mixxffy-Pets-win11-Setup-1.1.1.exe",
      windowsPortable: "Mixxffy-Pets-win11-1.1.1.exe",
      macArm: "Mixxffy.Pets-1.1.1-arm64.dmg",
      macX64: "Mixxffy.Pets-1.1.1-x64.dmg",
    },
    unavailableText: {
      windowsSetup: "灰度开放中",
      windowsPortable: "灰度开放中",
      macArm: "待开放",
      macX64: "待开放",
    },
    downloadOptions: [
      {
        ...
        hint: "推荐 Windows 10/11",
        meta: "灰度入口",
        filename: "Mixxffy-Pets-win11-Setup-1.1.1.exe",
        disabled: true,
      },
      {
        key: "windowsPortable",
        ...
        hint: "免安装版本",
        meta: "灰度入口",
        filename: "Mixxffy-Pets-win11-1.1.1.exe",
        disabled: true,
      },
      {
        key: "macArm",
        ...
        hint: "Apple Silicon / M 系列",
        meta: "待开放",
        filename: "Mixxffy.Pets-1.1.1-arm64.dmg",
        disabled: true,
      },
      {
        key: "macX64",
        ...
        hint: "Intel Mac",
        meta: "待开放",
        filename: "Mixxffy.Pets-1.1.1-x64.dmg",
        disabled: true,
      },
    ],
  },
...
const groupPetCollections = {
  ...
  nmixx: ["assets/groups/nmixx/pet/bae.png", "assets/groups/nmixx/pet/haewon.png", "assets/groups/nmixx/pet/jiwoo.png", "assets/groups/nmixx/pet/kyujin.png", "assets/groups/nmixx/pet/lily.png", "assets/groups/nmixx/pet/sullyoon.png"],
