...
const apps = [
  ...
  },
  {
    ...
    status: "Gray release",
    summary:
      "NCT 127 桌宠合集，包含 Doyoung、Haechan、Jaehyun、Johnny、Jungwoo、Taeyong、Yuta 七个桌面伙伴。当前 release 还在整理中，下载入口先灰度展示。",
    docPath: "docs/127pets.md",
    docDownloadPath: "docs/127pets.pdf",
    docDownloadName: "127pets-使用说明.pdf",
    releaseNotePath: "docs/127pets.md",
    downloadHint: "release 附件还在整理中，下载入口先灰度展示",
    unavailableText: {
      windowsSetup: "灰度中",
      windowsPortable: "灰度中",
      macArm: "灰度中",
    ...
    notes: [
      "当前 release 附件还未完全准备好，下载入口先灰度展示。",
      "Windows 将提供安装版和便携版。",
      "macOS 将提供 Apple Silicon 与 Intel 两个版本。",
      "包含 Doyoung、Haechan、Jaehyun、Johnny、Jungwoo、Taeyong、Yuta 七个桌宠。",
    ],
    files: {
      windows: "127-Pets-win11-Setup-1.1.0.exe",
      windowsPortable: "127-Pets-win11-1.1.0.exe",
      macArm: "127.Pets-1.1.0-arm64.dmg",
      macX64: "127.Pets-1.1.0-x64.dmg",
    },
    downloadOptions: [
      {
        key: "windowsSetup",
        ...
        hint: "推荐 Windows 10/11",
        meta: "release 整理中",
        filename: "127-Pets-win11-Setup-1.1.0.exe",
        disabled: true,
      },
      {
        key: "windowsPortable",
        ...
        hint: "免安装版本",
        meta: "release 整理中",
        filename: "127-Pets-win11-1.1.0.exe",
        disabled: true,
      },
      {
        key: "macArm",
        ...
        hint: "Apple Silicon / M 系列",
        meta: "release 整理中",
        filename: "127.Pets-1.1.0-arm64.dmg",
        disabled: true,
      },
      {
        key: "macX64",
        ...
        hint: "Intel Mac",
        meta: "release 整理中",
        filename: "127.Pets-1.1.0-x64.dmg",
        disabled: true,
      },
    ],
  },
