...
const apps = [
  ...
  },
  {
    ...
    status: "Gray release",
    summary:
      "TRUZ 桌宠合集准备发布中，包含 Bonbon、Chilli、Hikun、Lawoo、Podong、Romy、Ruru、Som、Woopy、Yochi 十只桌面伙伴。",
    docPath: "docs/truz.md",
    docDownloadName: "truz-使用说明.md",
    releaseNotePath: "docs/truz.md",
    downloadHint: "下载入口灰度中，使用说明可先下载",
    unavailableText: {
      windowsSetup: "灰度中",
      windowsPortable: "灰度中",
      macArm: "待发布",
    ...
    files: {
      windows: "TRUZ-Pets-win11-Setup-1.1.0.exe",
      windowsPortable: "TRUZ-Pets-win11-1.1.0.exe",
      macArm: "TRUZ.Pets-1.1.0-arm64.dmg",
      macX64: "TRUZ.Pets-1.1.0-x64.dmg",
    },
    downloadOptions: [
      {
        key: "windowsSetup",
        ...
        hint: "推荐 Windows 10/11",
        meta: "安装包 .exe",
        filename: "TRUZ-Pets-win11-Setup-1.1.0.exe",
        disabled: true,
      },
      {
        key: "windowsPortable",
        ...
        hint: "免安装版本",
        meta: "便携版 .exe",
        filename: "TRUZ-Pets-win11-1.1.0.exe",
        disabled: true,
      },
      {
        key: "macArm",
        ...
        hint: "Apple Silicon / M 系列",
        meta: "磁盘映像 .dmg",
        filename: "TRUZ.Pets-1.1.0-arm64.dmg",
        disabled: true,
      },
      {
        key: "macX64",
        ...
        hint: "Intel Mac",
        meta: "磁盘映像 .dmg",
        filename: "TRUZ.Pets-1.1.0-x64.dmg",
        disabled: true,
      },
    ],
  },
