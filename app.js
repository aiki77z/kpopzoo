...
const apps = [
  ...
  },
  {
    ...
    status: "Latest release",
    summary:
      "SVT 桌宠合集已更新到 v1.1.0，包含 13 只角色，支持 Windows 安装版/便携版和 macOS ARM64 下载。",
    docPath: "docs/svt.txt",
    releaseNotePath: "docs/svt.md",
    notes: [
      "Windows 用户优先选择 Setup 安装包。",
      "Windows 便携版适合不想安装的用户。",
      "macOS ARM64 适合 Apple Silicon / M 系列芯片。",
      "发布时只上传安装包，不公开源码和素材源文件。",
    ],
    files: {
      windows: "SVT-Pets-win11-Setup-1.1.0.exe",
      windowsPortable: "SVT-Pets-win11-1.1.0.exe",
      macArm: "SVT.Pets-1.1.0-arm64.dmg",
    },
    downloadOptions: [
      {
        key: "windowsSetup",
        ...
        hint: "推荐 Windows 10/11",
        meta: "安装包 .exe",
        filename: "SVT-Pets-win11-Setup-1.1.0.exe",
      },
      {
        key: "windowsPortable",
        ...
        hint: "免安装版本",
        meta: "便携版 .exe",
        filename: "SVT-Pets-win11-1.1.0.exe",
      },
      {
        key: "macArm",
        label: "macOS ARM64 v1.1.0",
        hint: "Apple Silicon / M 系列",
        meta: "磁盘映像 .dmg",
        filename: "SVT.Pets-1.1.0-arm64.dmg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    status: "Latest release",
    summary:
      "NCT 127 桌宠合集现已发布，包含 Doyoung、Haechan、Jaehyun、Johnny、Jungwoo、Taeyong、Yuta 七个桌面伙伴，提供 Windows 安装版/便携版与 macOS 双架构下载。",
    docPath: "docs/127pets.md",
    docDownloadPath: "docs/127pets.pdf",
    docDownloadName: "127pets-使用说明.pdf",
    releaseNotePath: "docs/127pets.md",
    downloadHint: "点击卡片直接下载",
    notes: [
      "Windows 用户优先选择 Setup 安装包。",
      "Windows 便携版适合不想安装的用户。",
      "macOS arm64 适合 Apple Silicon；x64 适合 Intel Mac。",
      "包含 Doyoung、Haechan、Jaehyun、Johnny、Jungwoo、Taeyong、Yuta 七个桌宠。",
    ],
    files: {
      windows: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127-Pets-win11-Setup-1.1.0.exe",
      windowsPortable: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127-Pets-win11-1.1.0.exe",
      macArm: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127.Pets-1.1.0-arm64.dmg",
      macX64: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127.Pets-1.1.0-x64.dmg",
    },
    downloadOptions: [
      {
        key: "windowsSetup",
        ...
        hint: "推荐 Windows 10/11",
        meta: "安装包 .exe",
        filename: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127-Pets-win11-Setup-1.1.0.exe",
      },
      {
        key: "windowsPortable",
        label: "Windows 便携版 v1.1.0",
        hint: "免安装版本",
        meta: "便携版 .exe",
        filename: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127-Pets-win11-1.1.0.exe",
      },
      {
        key: "macArm",
        label: "macOS ARM64 v1.1.0",
        hint: "Apple Silicon / M 系列",
        meta: "磁盘映像 .dmg",
        filename: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127.Pets-1.1.0-arm64.dmg",
      },
      {
        key: "macX64",
        label: "macOS x64 v1.1.0",
        hint: "Intel Mac",
        meta: "磁盘映像 .dmg",
        filename: "https://github.com/aiki77z/kpopzoo/releases/download/127pets-v1.1.0/127.Pets-1.1.0-x64.dmg",
      },
    ],
  },
  {
...
const groupAppLogoSources = {
  ...
  "127pets": "assets/groups/127pets/app-logo.png",
...
const groupPetCollections = {
  ...
  nmixx: ["assets/groups/nmixx/pet/bae.gif?v=2", "assets/groups/nmixx/pet/haewon.gif?v=2", "assets/groups/nmixx/pet/jiwoo.gif?v=2", "assets/groups/nmixx/pet/kyujin.gif?v=2", "assets/groups/nmixx/pet/lily.gif?v=2", "assets/groups/nmixx/pet/sullyoon.gif?v=2"],
  "127pets": ["assets/groups/127pets/pet/doyoung.gif?v=2", "assets/groups/127pets/pet/haechan.gif?v=2", "assets/groups/127pets/pet/jaehyun.gif?v=2", "assets/groups/127pets/pet/johnny.gif?v=2", "assets/groups/127pets/pet/jungwoo.gif?v=2", "assets/groups/127pets/pet/taeyong.gif?v=2", "assets/groups/127pets/pet/yuta.gif?v=2"],
...
const groupTrackConfig = {
  ...
  "127pets": { title: "Fact Check", artist: "NCT 127", src: null, cover: null },
...
const groupThemeSeeds = {
  ...
  "127pets": {
    device: "media-machine",
    player: "disc",
    light: ["#f7fbf5", "#ffffff", "#d8ead2", "#3f8f6b", "#1f2d27", "#fbfff8"],
  },
  svt: {
